...
//TODO			Toast.makeText(context, context.getString(R.string.Bluetoothisnotavailable), Toast.LENGTH_LONG).show();
			// finish();
			return;
		}
...
//TODO		Toast.makeText(context, context.getString(R.string.Connecting), Toast.LENGTH_LONG).show();
...
//TODO				Toast.makeText(context, context.getString(R.string.Connected), Toast.LENGTH_LONG).show();
			} catch (IOException e) {
				try {
					btSocket.close();
					Connected = false;

//TODO					Toast.makeText(context, context.getString(R.string.Unabletoconnect), Toast.LENGTH_LONG).show();
...
//TODO			Toast.makeText(context, context.getString(R.string.Disconnected), Toast.LENGTH_LONG).show();
