 ...
 * 
 * From:
 * http://stackoverflow.com/questions/785973/what-is-the-most-appropriate-way
 * -to-store-user-settings-in-android-application
 * 
 * final SharedPreferences prefs = new ObscuredSharedPreferences( this,
 * this.getSharedPreferences(MY_PREFS_FILE_NAME, Context.MODE_PRIVATE) );
 * 
 * prefs.edit().putString("foo","bar").commit(); prefs.getString("foo");
 * 
 */
