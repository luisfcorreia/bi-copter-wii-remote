...
public class Config extends Activity implements OnClickListener{
	...
	public void onClick(View v) {
		...
		case R.id.btnConnect:
			...
			Config.this.startActivityForResult(myIntent,REQUEST_CONNECT_DEVICE);
			Config.this.startActivityForResult(myIntent,
	...
	public void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case REQUEST_CONNECT_DEVICE:
			...
			if (resultCode == Activity.RESULT_OK) {
				...
				MultiWiiBT_menu.prefs.edit().putString("remote_device", MultiWiiBT_menu.remote_device_mac)
						.commit();

				Toast.makeText(
						this,
						"Bluetooth device address " + MultiWiiBT_menu.remote_device_mac
